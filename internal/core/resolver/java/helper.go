...
func (javaHelper *Helper) LookupMethodReturn(typeName, methodName string, argTypes []string) (model.ReturnType, bool) {
	return javaHelper.externalMethods.Lookup(typeName, methodName, argTypes)
}
